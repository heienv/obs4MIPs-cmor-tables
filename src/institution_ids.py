...
institution_id['institution_id']['EUMETSAT-CMSAF'] = 'EUMETSAT Satellite Application Facility on Climate Monitoring, Offenbach, Germany'
...
institution_id['institution_id']['NASA-GMAO'] = 'NASA-GMAO (NASA Global Modeling and Assimilation Office),Greenbelt MD, USA'
...
institution_id['institution_id']['UCSB-CHC'] = 'University of California, Santa Barbara, Climate Hazards Center'
...
institution_id['institution_id']['ENVEO'] = 'ENVEO-Environmental Earth Observation Information Technology GmbH, Innsbruck, Austria'
