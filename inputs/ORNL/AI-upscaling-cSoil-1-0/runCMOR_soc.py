...
def main():
    ...
    for depth_cm in (30, 100):
        ...
        metadata["comment"] = (
            "Complete native source grid retained without cropping or "
            "resampling; spatial extent 180 W-55 W, 15 N-80 N. This static "
            f"product represents cumulative 0-{depth_cm} cm contemporary "
            "baseline soil organic carbon stock, generated by upscaling "
            "multi-decadal soil-profile observations with region-specific "
            "Random Forest models and environmental covariates. It is not "
            "a temporal mean or time series."
        )
